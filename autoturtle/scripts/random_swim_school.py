...
class ControlTurtlesim():
    ...
    def __init__(self):
        ...
        while not rospy.is_shutdown():
            ...
            if (count % (move_cmd.linear.x * 10) >= move_cmd.linear.x * 10 - 1):
                move_cmd.angular.z =  move_cmd.angular.z * -1

            #rospy.loginfo(count % (move_cmd.linear.x * 10))
